    ...
    return (
        <div>
            ...
            <ul style={styles.format}>
                ...
                <span style={{fontWeight: 'bold', fontSize: '25px', margin: '10px'}}>A 4 person project to help with boredom.</span>
                </a>
                ...
                <span style={{fontWeight: 'bold', fontSize: '25px'}}>A 4 person project to help with name suggestions for plants.</span>
                </a>
                ...
                <span style={{fontWeight: 'bold', fontSize: '25px'}}>A app to keep track of notes, utilizing local storage.</span>
                </a>
                ...
                <span style={{fontWeight: 'bold', fontSize: '25px'}}>A project to help you create a password that is randomly generated.</span>
                </a>
            </ul>
        </div>
    );
